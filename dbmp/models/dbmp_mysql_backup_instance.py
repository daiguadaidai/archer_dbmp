...
class DbmpMysqlBackupInstance(models.Model):
    ...
    backup_tool = models.IntegerField(choices=FieldDbmpMysqlBackupInstance.backup_tool())
    backup_type = models.IntegerField(choices=FieldDbmpMysqlBackupInstance.backup_type())
    is_all_instance = models.IntegerField(choices=FieldDbmpMysqlBackupInstance.is_all_instance())
    is_binlog = models.IntegerField(choices=FieldDbmpMysqlBackupInstance.is_binlog())
    is_compress = models.IntegerField(choices=FieldDbmpMysqlBackupInstance.is_compress())
    is_to_remote = models.IntegerField(choices=FieldDbmpMysqlBackupInstance.is_to_remote())
